...
if (startIndex !== -1) {
  ...
  // The line ends somewhere, we can just take from jsonStart to the end, but the file might have other things.
  // In the view_file output, it looks like `window.__REVIEWS__ = [{"id": 1, ...}]` on a single line.
